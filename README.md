...
###  Core Interests
- **Landscape Phenomenology**: Quantifying human experience through GIS.
- **Movement Analysis**: Using Circuit Theory and Cost-Surface modeling.
- **Acoustic Modeling**: Simulating sound propagation in ancient environments.
